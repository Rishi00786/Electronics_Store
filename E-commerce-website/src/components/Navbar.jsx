...
const Navbar = () => {
    ...
    return (
        <>
            <div className='first w-screen h-12 bg-gray-800 flex text-white items-center justify-between font-thin text-sm'>
                ...
                <div className='flex gap-12 mr-12' id='firstdetails'>
                    <div><Link to="/about"><u>About</u></Link></div>
                    <div><Link to="/contact"><u>Contact</u></Link></div>
                    <div><Link to="/help"><u>Help</u></Link></div>
            ...
            <div id='second' className='second w-screen h-20 bg-blue-200 flex flex-col gap-4  justify-center'>
                <div className='flex items-center justify-between text-black'>
                    ...
                    <div className='flex mr-12 gap-12'>
                        <div id='login' className='flex gap-2'>
                            ...
                            <div className='font-light'>Log In</div>
                        </div>
                ...
                {display && <div className='justify-center' id='input2'>
                    <input type="text" placeholder='Search..' className='rounded-l-full text-center w-72' id="inp" />
                    <div className='w-20 h-12 bg-purple-500 flex items-center justify-center rounded-r-full'>
                        <button><i className="fa-solid fa-magnifying-glass text-white"></i></button>
                    </div>
                </div>}
            ...
            {!display && <div id='third' className='w-screen h-12 bg-gray-200 flex items-center gap-8 font-light text-sm'>
                <div className='ml-12'>Shop All</div>
                <div>Computers</div>
                <div>Tablets</div>
                <div>Drones and Cameras</div>
                <div>Mobiles</div>
                <div>T.V & Home Cinema</div>
                <div>Wearable Watch</div>
                <div>Sale</div>
            </div>}
        </>
    );
